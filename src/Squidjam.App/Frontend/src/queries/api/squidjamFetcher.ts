import { SquidjamContext } from './squidjamContext';

const baseUrl = ''; // TODO add your baseUrl

export type ErrorWrapper<TError> = TError | { status: 'unknown'; payload: string };

export type SquidjamFetcherOptions<TBody, THeaders, TQueryParams, TPathParams> = {
    url: string;
    method: string;
    body?: TBody;
    headers?: THeaders;
...
export async function squidjamFetch<
    TData,
    TError,
...
>({
    ...
    queryParams,
    signal,
}: SquidjamFetcherOptions<TBody, THeaders, TQueryParams, TPathParams>): Promise<TData> {
    try {
